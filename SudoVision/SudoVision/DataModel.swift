...
final class DataModel: ObservableObject {
    ...
    var currentPhoto: Image?
    @State var currentPhotoExists: Bool = false
...
//            }
            savePhoto(image: photoData.thumbnailImage)
        }
    }
    ...
    func savePhoto(image: Image) {
        currentPhoto = viewfinderImage
